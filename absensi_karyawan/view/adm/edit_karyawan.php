<?php 
    ...
    $sql_sw = "SELECT*FROM detail_user NATURAL LEFT JOIN user WHERE id_user= '$id_karyawan'";
  ...
  <div class="form-group">
    ...
    <div class="col-sm-10">
      <input type="text" value="<?php echo $sklh_user; ?>" class="form-control" name="sklh" placeholder="Masukan Nama Divisi" required>
    </div>
  </div>
  <div class="form-group">
  ...
  <div class="form-group"> 
    <div class="col-sm-offset-2 col-sm-10">
      <button type="submit" class="btn btn-default" name="edit_karyawan">Simpan</button>
      <button type="button" onclick="hapusKaryawan(<?php echo $id_user; ?>)" class="btn btn-danger" name="">Hapus karyawan</button>
    </div>
  </div>
</form>
<?php
