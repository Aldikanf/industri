...
<form class="form-horizontal" role="form" style="width:80%" onSubmit="return validasi()" name="formulir" method="post" action="./model/proses.php">
  ...
  <div class="form-group">
    ...
    <div class="col-sm-10">
      <input type="text" class="form-control" name="sklh" placeholder="Masukan Nama Divisi" required>
    </div>
  </div>
  <div class="form-group">
  ...
  <div class="form-group"> 
    <div class="col-sm-offset-2 col-sm-10">
      <button type="submit" class="btn btn-default" name="add_karyawan">Simpan</button>
      <button type="reset" class="btn btn-warning" name="add_karyawan">Reset</button>
    </div>
  </div>
</form>
